...
import Query from '../components/query_vh';
...
const STYLES = {
  ...
  content: { marginLeft:SIDEBAR_WIDTH,flex: 1, overflow: 'auto', paddingLeft: '5px' },
  collapse: {
    position: 'fixed',
    color: '#fff',
    cursor: 'pointer',
    ...
    return (
      <div style={STYLES.wrapper}>
        ...
        <div style={STYLES.container}>
          ...
          <div style={{marginLeft:this.state.sideBarWidth,backgroundColor:"#0F0"}}>
