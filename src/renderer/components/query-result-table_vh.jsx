...
export default class QueryResultTable extends Component {
  ...
  resize(nextProps) {
    console.log("============table resize");
     ...
     // if(this.mystate.tableHeight<=0) {this.mystate.tableHeight=350;}
     // if (this.mystate.tableHeight>(this.props.rowsCount+1)*rowHeight){
     //     this.mystate.tableHeight=(this.props.rowsCount+1)*rowHeight;
     // }
     // console.log(this.mystate.tableHeight);
    // let tableWidth;
  ...
  renderHeaderTopBar() {
    ...
    return (
      <div style={{ width:this.mystate.tableWidth,height:"25px",background: 'rgba(0, 0, 0, 0.05)', overflow: 'hidden' }}>
  ...
  renderTableBody(onScroll) {
    ...
    let rowVisible=rowCount;
    if (rowVisible>10) rowVisible=10;
    var h=rowVisible*rowHeight;
  ...
  render=()=> {
    ...
    <div id="inside AutoSizer">
          ...
          {(params2) =>{ 
              ...
              return (
                <div  sytle={{width:this.mystate.tableWidth,height:this.mystate.tableHeight}} className="grid-query-wrapper">
                  {
