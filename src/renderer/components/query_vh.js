...
import QueryResult from './query-result_vh.jsx';
...
export default class Query extends Component {
  ...
  constructor(props, context) {
    ...
    // tab_inner_h=window.innerHeight-150;
  }
...
//     return(<div style={{height:"60vh",overflow:"auto",
//   backgroundColor:"#777", 
...
<div>{this.state &&
  ...
  <style jsx="true">{`
        ...
        `}</style>
  <AceEditor style={{  height:QUERY_EDITOR_HEIGTH
                       ,width:"100%"
                    }}
                    mode="sql"
              theme="github"
